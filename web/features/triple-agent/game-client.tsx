...
import { InterludeScreen } from "@/features/triple-agent/screens/interlude-screen";
...
import { SettingsScreen } from "@/features/triple-agent/screens/settings-screen";
...
function ScreenContent({ screen, playerName, setPlayerName, roomCode, setRoomCode, roomCodeCopied, copyRoomCode, timerEnabled, setTimerEnabled, navigate, operationId, setOperationId, projection, liveSession, onCommand, onCreateRoom, onJoinRoom, onLeave, leaving, error }: {
  ...
  operationId: Parameters<typeof OperationScreen>[0]["operationId"];
  setOperationId: (id: Parameters<typeof OperationScreen>[0]["operationId"]) => void;
...
export function GameClient() {
  ...
  const [operationId, setOperationId] = useState<Parameters<typeof OperationScreen>[0]["operationId"]>("OneRandom");
