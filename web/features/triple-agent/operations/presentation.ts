...
export const operationBriefs: Record<string, string> = {
  ...
  Strain: "HIDDEN AGENDA - The active player gets special orders from the top. They now win if and only if they are imprisoned, in which case the service and the virus agents will lose. They still officially work for the same side.",
  Grudge: "HIDDEN AGENDA - The active player has a grudge against someone they now win if and only if their target is imprisoned.",
  Infatuation: "HIDDEN AGENDA - The active player falls madly in love with some one they now win if and only if the object of their affection wins.",
  Flip: "HIDDEN AGENDA - The active player switches sides if they were working for the service they are now a virus agent and vice versa.",
  ...
  Defect: "The active player may defect and join the other team. A VIRUS defector loses if any other virus agent votes for them. A Service defector can't vote.",
